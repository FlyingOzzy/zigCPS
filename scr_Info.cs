...
namespace HXApiTesterCS {
    public partial class scr_Info : UserControl {
        ...
        public void setConnType(int type) { mConnType = type; updateSelectedIndex(); }

        public void setApi_20(Hx20Api api) { m_api_20 = api; }

        private void initControls() { cmb_axis.SelectedIndex = 0; }
        ...
        private void setUpdateData(TextBox tb, double dval) { tb.Text = dval.ToString("F3"); }
        ...
        private void tb_ab_min_KeyPress(object sender, KeyPressEventArgs e) {
            ...
            if (e.KeyChar == (char)13) {
                ...
                if(mConnType == 0) { m_api_20.SetPMF(ABSO_POSADDR + mSelected_idx, d); }
                
                else if(mConnType == 1) { HXApi.HXSetRegister64(HXMap.HX_PM, ABSO_POSADDR + mSelected_idx, d); }
            }
        }
        ...
        private void tb_ab_max_KeyPress(object sender, KeyPressEventArgs e) {
            ...
            if(e.KeyChar == (char)13) {
                ...
                if(mConnType == 0) { m_api_20.SetPMF(ABSO_POSADDR + mSelected_idx * 2 + 1, d); }
                
                else if(mConnType == 1) { HXApi.HXSetRegister64(HXMap.HX_PM, ABSO_POSADDR + mSelected_idx * 2 + 1, d); }
            }
        }
        ...
        private void tb_jog_vel_KeyPress(object sender, KeyPressEventArgs e) {
            ...
            if (e.KeyChar == (char)13) {
                ...
                if(mConnType == 0) { m_api_20.SetPUF(JOG_MOVE_VEL_ADDR + mSelected_idx, d); }
                
                else if (mConnType == 1) { HXApi.HXSetRegister64(HXMap.HX_PU, JOG_MOVE_VEL_ADDR + mSelected_idx, d); }
            }
        }
        ...
        private void tb_tar_vel_KeyPress(object sender, KeyPressEventArgs e) {
            ...
            if (e.KeyChar == (char)13) {
                ...
                if (mConnType == 0) { m_api_20.SetPUF(TARGET_MOVE_VEL + mSelected_idx, d); }
             
                else if (mConnType == 1) { HXApi.HXSetRegister64(HXMap.HX_PU, TARGET_MOVE_VEL + mSelected_idx, d); }
            }
        }
        ...
        private void tb_step_vel_KeyPress(object sender, KeyPressEventArgs e) {
            ...
            if (e.KeyChar == (char)13) {
                ...
                if (mConnType == 0) { m_api_20.SetPUF(STEP_MOVE_VEL + mSelected_idx, d); }
                
                else if (mConnType == 1) { HXApi.HXSetRegister64(HXMap.HX_PU, STEP_MOVE_VEL + mSelected_idx, d); }
            }
        }
        ...
        private void tb_homing_acc_KeyPress(object sender, KeyPressEventArgs e) {
            ...
            if (e.KeyChar == (char)13) {
                ...
                if (mConnType == 0) { m_api_20.SetPMF(ACCEL_ADDR + mSelected_idx, d); }
                
                else if (mConnType == 1) {HXApi.HXSetRegister64(HXMap.HX_PM, ACCEL_ADDR + mSelected_idx, d); }
            }
        }
        ...
        private void tb_homing_1st_KeyPress(object sender, KeyPressEventArgs e) {
            ...
            if (e.KeyChar == (char)13) {
                ...
                if (mConnType == 0) { m_api_20.SetPMF(VEL_1ST_ADDR + mSelected_idx, d); }

                else if (mConnType == 1) { HXApi.HXSetRegister64(HXMap.HX_PM, VEL_1ST_ADDR + mSelected_idx, d); }
            }
        }
        ...
        private void tb_homing_vel_KeyPress(object sender, KeyPressEventArgs e) {
            ...
            if (e.KeyChar == (char)13) {
                ...
                if (mConnType == 0) { m_api_20.SetPMF(HOME_VEL_ADDR + mSelected_idx, d); }

                else if (mConnType == 1) { HXApi.HXSetRegister64(HXMap.HX_PM, HOME_VEL_ADDR + mSelected_idx, d); }
            }
        }
        ...
        private void tb_homing_2nd_KeyPress(object sender, KeyPressEventArgs e) {
            ...
            if (e.KeyChar == (char)13) {
                ...
                if (mConnType == 0) { m_api_20.SetPMF(VEL_2ND_ADDR + mSelected_idx, d); }
                
                else if (mConnType == 1) { HXApi.HXSetRegister64(HXMap.HX_PM, VEL_2ND_ADDR + mSelected_idx, d); }
            }
        }
        ...
        private void tb_homing_ban_KeyPress(object sender, KeyPressEventArgs e) {
            ...
            if (e.KeyChar == (char)13) {
                ...
                if (mConnType == 0) { m_api_20.SetPMF(BAN_ADDR + mSelected_idx, d); }
                
                else if (mConnType == 1) { HXApi.HXSetRegister64(HXMap.HX_PM, BAN_ADDR + mSelected_idx, d); }
            }
        }
        ...
        private void cb_random_CheckedChanged(object sender, EventArgs e) {
            ...
            if (mConnType == 0) {
                if (check == CheckState.Checked) { m_api_20.SetPMF(ZRN_ADDR + mSelected_idx, 1); }
                
                else if (check == CheckState.Unchecked) { m_api_20.SetPMF(ZRN_ADDR + mSelected_idx, 0); }
            }

            else if (mConnType == 1) {
                if (check == CheckState.Checked) { HXApi.HXSetRegister64(HXMap.HX_PM, ZRN_ADDR + mSelected_idx, 1); }
                
                else if (check == CheckState.Unchecked) { HXApi.HXSetRegister64(HXMap.HX_PM, ZRN_ADDR + mSelected_idx, 0); }
            }
        }
        ...
        private void cb_dog_CheckedChanged(object sender, EventArgs e) {
            ...
            if (mConnType == 0) {
                if (check == CheckState.Checked) { m_api_20.SetPMF(ZRN_DOG_ADDR + mSelected_idx, 1); }
            
                else if (check == CheckState.Unchecked) { m_api_20.SetPMF(ZRN_DOG_ADDR + mSelected_idx, 0); }                
            }

            else if (mConnType == 1) {
                if (check == CheckState.Checked) { HXApi.HXSetRegister64(HXMap.HX_PM, ZRN_DOG_ADDR + mSelected_idx, 1); }
                
                else if (check == CheckState.Unchecked) { HXApi.HXSetRegister64(HXMap.HX_PM, ZRN_DOG_ADDR + mSelected_idx, 0); }
            }
        }
        ...
        private void cb_ab_use_CheckedChanged(object sender, EventArgs e) {
            ...
            if (mConnType == 0) {
                if (check == CheckState.Checked) { m_api_20.SetPMF(SOFT_LIMIT_ADDR + mSelected_idx, 0); }
                
                else if (check == CheckState.Unchecked) { m_api_20.SetPMF(SOFT_LIMIT_ADDR + mSelected_idx, 1); }                               
            }

            else if (mConnType == 1) {
                if (check == CheckState.Checked) { HXApi.HXSetRegister64(HXMap.HX_PM, SOFT_LIMIT_ADDR + mSelected_idx, 0); }

                else if (check == CheckState.Unchecked) { HXApi.HXSetRegister64(HXMap.HX_PM, SOFT_LIMIT_ADDR + mSelected_idx, 1); }
            }
        }
    }
}
