...
namespace HXApiTesterCS {
    public partial class Dialog_Connection : Form {
        ...
        private void InitControls() { tb_ip.Text = "192.168.226.133"; }     // need to check the IP address for zig in lab
        ...
        private void btn_cancel_Click(object sender, EventArgs e) { bOK = false; this.Close(); }
    }
}
